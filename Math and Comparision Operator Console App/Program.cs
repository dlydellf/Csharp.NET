...
namespace Math_and_Comparision_Operator_Console_App
{
    class Program
    {
        static void Main()
        {
            ...
            Console.WriteLine("How many hours do you work per week? (xx)"); // program's 2nd required question for 'Person 1'
            ...
            Console.WriteLine("How many hours do you work per week? (xx)"); // program's 2nd required question for 'Person 2'
